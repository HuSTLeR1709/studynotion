...
import "./Footer.css";
import { FaLinkedin, FaTwitter, FaGoogle, FaInstagram, FaGithub } from "react-icons/fa";
          ...
          <div className="row">
            ...
            <div className="footer-col">
              ...
              <div className="social-links">
                <a
                  href="https://www.linkedin.com/in/nabhjeet-katiyar-b319a7196/"
                  target="blank"
                >
                  <FaLinkedin className=" mx-auto mt-3 scale-125" />
                </a>
                <a href="https://github.com/HuSTLeR1709" target="blank">
                  <FaGithub className=" mx-auto mt-3 scale-125" />
                </a>

                <a href="https://www.instagram.com/nabhjeet_katiyar/#" target="blank">
